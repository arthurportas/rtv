...
public class ShowParticipation extends BaseEntity implements Serializable {
	...
	/**
	 * @return the lastBeginPlaying {@link Date}
	 */
	 ...
	 *            - the lastBeginPlaying {@link Date} to set
	 */
	...
	/**
	 * @return the lastEndPlaying {@link Date}
	 */
	 ...
	 *            the lastEndPlaying {@link Date} to set
	 */
	...
	/**
	 * @return the associated {@link Show}
	 */
	public Show getShow() {
		return show;
	}
	...
	/**
	 * @return the associated {@link Client} list
	 */
	...
	/**
	 * @param clients
	 *            - the {@link Client} list to associate
	 */
